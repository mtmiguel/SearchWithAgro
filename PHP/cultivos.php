    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <!-- Featured blog post-->
                <div class="card mb-4">
                    <a href="#!"><img class="card-img-top" src="CSS/IMG/campo1.jpg" alt="..." /></a>
                    <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <!-- Blog post-->
                        <div class="card mb-4">
                            <a href="#!"><img class="card-img-top" src="CSS/IMG/limonM.jpg" alt="..." /></a>
                            <div class="card-body">
                                <div class="small text-muted">1 de marzo, 2024</div>
                                <h2 class="card-title h4">Limon mandarino</h2>
                                <p class="card-text">
                                ...
                                <a class="btn btn-primary" href="infolimonmandarino.php">Leer más→</a>
                            </div>
                        </div>
                        <!-- Blog post-->
                        <div class="card mb-4">
                            <a href="#!"><img class="card-img-top" src="CSS/IMG/LIMON.jpg" alt="..." /></a>
                            <div class="card-body">
                                <div class="small text-muted">1 de marzo, 2024</div>
                                <h2 class="card-title h4">Limon</h2>
                                <p class="card-text">
                                limon  el cultivo de limón es una actividad agrícola importante en la región de Cúcuta, Colombia, que contribuye tanto a la economía local como al suministro de alimentos para la población. Los limones cultivados en la región son apreciados por su calidad y sabor, y forman parte integral de la dieta y la cultura culinaria de la región.                                <a class="btn btn-primary" href="infolimon.php">Leer más→</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!-- Blog post-->
                        <div class="card mb-4">
                            <a href="#!"><img class="card-img-top" src="CSS/IMG/manda.jpg" alt="..." /></a>
                            <div class="card-body">
                                <div class="small text-muted">1 de marzo, 2024</div>
                                <h2 class="card-title h4">Mandarina</h2>
                                <p class="card-text">
                                el cultivo de mandarina es una actividad agrícola importante en la región de Cúcuta, Colombia, que contribuye tanto a la economía local como al suministro de alimentos para la población. Las mandarinas cultivadas en la región son apreciadas por su calidad y sabor, y forman parte integral de la dieta y la cultura culinaria de la región.</p>                                <a class="btn btn-primary" href="infomandarina.php">Leer más→</a>
                            </div>
                        </div>
                        <!-- Blog post-->
                        <div class="card mb-4">
                            <a href="#!"><img class="card-img-top" src="CSS/IMG/Naranja.jpg" alt="..." /></a>
                            <div class="card-body">
                                <div class="small text-muted">1 de marzo, 2024</div>
                                <h2 class="card-title h4">Naranja</h2>
                                <p class="card-text">
                                El cultivo de naranja es una actividad agrícola importante en la región de Cúcuta, Colombia, que contribuye tanto a la economía local como al suministro de alimentos para la población. Las naranjas cultivadas en la región son apreciadas por su calidad y sabor, y forman parte integral de la dieta y la cultura culinaria de la región.</p>                                <a class="btn btn-primary" href="infonaranja.php">Leer más→</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                ...
                <nav aria-label="Pagination">
                    ...
                    <li class="page-item"><a class="page-link" href="cultivos.php">Anterior</a></li>
                        <li class="page-item active"><a class="page-link" href="cultivos.php">1</a></li>
